...
class ColorCatalogWriterTest {
  ...
  @Test
  fun `GIVEN generateResourceProperties enabled THEN generate property extensions only`() {
    writer.write(
      resources,
      sourceSetName = "main",
  ...
  @Test
  fun `GIVEN only generateComposeExtensions enabled THEN generate compose extensions only`() {
    writer.write(
      resources,
      sourceSetName = "main",
      codegenDestination = codegenDestination,
      generateResourceProperties = false,
      generateResourcesExtensions = false,
      generateComposeExtensions = true,
    )
    assertThat(
  ...
  @Test
  fun `GIVEN all enabled THEN generate property, resources and compose extensions`() {
    writer.write(
      resources,
      sourceSetName = "main",
      codegenDestination = codegenDestination,
