    ...
    assertThat(
      ...
      """
        ...
        public object StringArrays {
           ...
           * String array 1 docs
           */
          public inline val stringArray1: Array<String>
            @Composable
            @ReadOnlyComposable
            get() = stringArrayResource(R.array.string_array_1)

          public inline val stringArray2: Array<String>
            @Composable
            @ReadOnlyComposable
    ...
    assertThat(
      ...
      """
        ...
        internal object StringArrays {
           ...
           * String array 1 docs
           */
          internal inline val stringArray1: Array<String>
            @Composable
            @ReadOnlyComposable
            get() = stringArrayResource(R.array.string_array_1)

          internal inline val stringArray2: Array<String>
            @Composable
            @ReadOnlyComposable
            get() = stringArrayResource(R.array.string_array_2)
        }
